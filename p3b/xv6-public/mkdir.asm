...
printint(int fd, int xx, int base, int sgn)
{
 ...
 318:	0f b6 92 a8 06 00 00 	movzbl 0x6a8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 3e5:	ff 24 85 50 06 00 00 	jmp    *0x650(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 44a:	75 15                	jne    461 <printf+0xfa>
          s = "(null)";
 44c:	be 47 06 00 00       	mov    $0x647,%esi
...
free(void *ap)
{
 ...
 4d9:	a1 54 09 00 00       	mov    0x954,%eax
 ...
 515:	89 08                	mov    %ecx,(%eax)
  freep = p;
 517:	a3 54 09 00 00       	mov    %eax,0x954
}
 51c:	5b                   	pop    %ebx
 51d:	5e                   	pop    %esi
 51e:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 574:	e8 54 ff ff ff       	call   4cd <free>
  return freep;
 579:	a1 54 09 00 00       	mov    0x954,%eax
...
malloc(uint nbytes)
{
 ...
 59d:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5a0:	8b 0d 54 09 00 00    	mov    0x954,%ecx
 ...
 5ac:	eb 4a                	jmp    5f8 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 5ae:	c7 05 54 09 00 00 58 	movl   $0x958,0x954
 5b5:	09 00 00 
 5b8:	c7 05 58 09 00 00 58 	movl   $0x958,0x958
 5bf:	09 00 00 
    base.s.size = 0;
 5c2:	c7 05 5c 09 00 00 00 	movl   $0x0,0x95c
 5c9:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5cc:	b9 58 09 00 00       	mov    $0x958,%ecx
 ...
 5dd:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5e0:	89 0d 54 09 00 00    	mov    %ecx,0x954
      return (void*)(p + 1);
 ...
 5fd:	73 d4                	jae    5d3 <malloc+0x46>
    if(p == freep)
 5ff:	39 05 54 09 00 00    	cmp    %eax,0x954
