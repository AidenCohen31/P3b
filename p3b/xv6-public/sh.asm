...
getcmd(char *buf, int nbuf)
{
  ...
  13:	6a 02                	push   $0x2
  15:	e8 89 0c 00 00       	call   ca3 <printf>
  memset(buf, 0, nbuf);
...
panic(char *s)
{
  ...
  59:	6a 02                	push   $0x2
  5b:	e8 43 0c 00 00       	call   ca3 <printf>
  exit();
...
00000084 <runcmd>:
{
  ...
  d1:	6a 02                	push   $0x2
  d3:	e8 cb 0b 00 00       	call   ca3 <printf>
    break;
 ...
 116:	68 6f 0f 00 00       	push   $0xf6f
 11b:	6a 02                	push   $0x2
 11d:	e8 81 0b 00 00       	call   ca3 <printf>
      exit();
...
execcmd(void)
{
 ...
 230:	6a 54                	push   $0x54
 232:	e8 92 0c 00 00       	call   ec9 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
 ...
 257:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 25a:	6a 18                	push   $0x18
 25c:	e8 68 0c 00 00       	call   ec9 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
 ...
 29f:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2a2:	6a 0c                	push   $0xc
 2a4:	e8 20 0c 00 00       	call   ec9 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
 ...
 2d5:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2d8:	6a 0c                	push   $0xc
 2da:	e8 ea 0b 00 00       	call   ec9 <malloc>
...
backcmd(struct cmd *subcmd)
{
 ...
 30b:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 30e:	6a 08                	push   $0x8
 310:	e8 b4 0b 00 00       	call   ec9 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
 ...
 35a:	50                   	push   %eax
 35b:	68 18 16 00 00       	push   $0x1618
 ...
 3d1:	50                   	push   %eax
 3d2:	68 18 16 00 00       	push   $0x1618
 ...
 3e9:	50                   	push   %eax
 3ea:	68 10 16 00 00       	push   $0x1610
 ...
 41d:	50                   	push   %eax
 41e:	68 18 16 00 00       	push   $0x1618
...
peek(char **ps, char *es, char *toks)
{
 ...
 45e:	50                   	push   %eax
 45f:	68 18 16 00 00       	push   $0x1618
...
nulterminate(struct cmd *cmd)
{
 ...
 7ee:	ff 24 85 20 10 00 00 	jmp    *0x1020(,%eax,4)
  case EXEC:
...
00000870 <parsecmd>:
{
 ...
 8c3:	50                   	push   %eax
 8c4:	68 e2 0f 00 00       	push   $0xfe2
 8c9:	6a 02                	push   $0x2
 8cb:	e8 d3 03 00 00       	call   ca3 <printf>
    panic("syntax");
 8d0:	c7 04 24 a6 0f 00 00 	movl   $0xfa6,(%esp)
...
000008dc <main>:
{
 ...
 984:	68 f9 0f 00 00       	push   $0xff9
 989:	6a 02                	push   $0x2
 98b:	e8 13 03 00 00       	call   ca3 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 c26:	89 ce                	mov    %ecx,%esi
  ...
  neg = 0;
  if(sgn && xx < 0){
 c28:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 c2c:	0f 95 c1             	setne  %cl
 c2f:	c1 ea 1f             	shr    $0x1f,%edx
 c32:	84 d1                	test   %dl,%cl
 c34:	74 44                	je     c7a <printint+0x62>
    neg = 1;
    x = -xx;
 c36:	f7 d8                	neg    %eax
 c38:	89 c1                	mov    %eax,%ecx
    neg = 1;
 c3a:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
 c41:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
 c46:	89 c8                	mov    %ecx,%eax
 c48:	ba 00 00 00 00       	mov    $0x0,%edx
 c4d:	f7 f6                	div    %esi
 c4f:	89 df                	mov    %ebx,%edi
 c51:	83 c3 01             	add    $0x1,%ebx
 c54:	0f b6 92 98 10 00 00 	movzbl 0x1098(%edx),%edx
 c5b:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
 c5f:	89 ca                	mov    %ecx,%edx
 c61:	89 c1                	mov    %eax,%ecx
 c63:	39 d6                	cmp    %edx,%esi
 c65:	76 df                	jbe    c46 <printint+0x2e>
  if(neg)
 c67:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 c6b:	74 31                	je     c9e <printint+0x86>
    buf[i++] = '-';
 c6d:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
 c72:	8d 5f 02             	lea    0x2(%edi),%ebx
 c75:	8b 75 d0             	mov    -0x30(%ebp),%esi
 c78:	eb 17                	jmp    c91 <printint+0x79>
    x = xx;
 c7a:	89 c1                	mov    %eax,%ecx
  neg = 0;
 c7c:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 c83:	eb bc                	jmp    c41 <printint+0x29>

  while(--i >= 0)
    putc(fd, buf[i]);
 c85:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 c8a:	89 f0                	mov    %esi,%eax
 c8c:	e8 6d ff ff ff       	call   bfe <putc>
  while(--i >= 0)
 c91:	83 eb 01             	sub    $0x1,%ebx
 c94:	79 ef                	jns    c85 <printint+0x6d>
}
 c96:	83 c4 2c             	add    $0x2c,%esp
 c99:	5b                   	pop    %ebx
 c9a:	5e                   	pop    %esi
 c9b:	5f                   	pop    %edi
 c9c:	5d                   	pop    %ebp
 ...
 ca1:	eb ee                	jmp    c91 <printint+0x79>
...
printf(int fd, const char *fmt, ...)
{
 ...
 ca9:	83 ec 1c             	sub    $0x1c,%esp
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
 cac:	8d 45 10             	lea    0x10(%ebp),%eax
 caf:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
 cb2:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
 cb7:	bb 00 00 00 00       	mov    $0x0,%ebx
 cbc:	eb 14                	jmp    cd2 <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
 cbe:	89 fa                	mov    %edi,%edx
 cc0:	8b 45 08             	mov    0x8(%ebp),%eax
 cc3:	e8 36 ff ff ff       	call   bfe <putc>
 cc8:	eb 05                	jmp    ccf <printf+0x2c>
      }
    } else if(state == '%'){
 cca:	83 fe 25             	cmp    $0x25,%esi
 ccd:	74 25                	je     cf4 <printf+0x51>
  for(i = 0; fmt[i]; i++){
 ccf:	83 c3 01             	add    $0x1,%ebx
 cd2:	8b 45 0c             	mov    0xc(%ebp),%eax
 cd5:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
 cd9:	84 c0                	test   %al,%al
 cdb:	0f 84 20 01 00 00    	je     e01 <printf+0x15e>
    c = fmt[i] & 0xff;
 ce1:	0f be f8             	movsbl %al,%edi
 ce4:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
 ce7:	85 f6                	test   %esi,%esi
 ce9:	75 df                	jne    cca <printf+0x27>
      if(c == '%'){
 ceb:	83 f8 25             	cmp    $0x25,%eax
 cee:	75 ce                	jne    cbe <printf+0x1b>
        state = '%';
 cf0:	89 c6                	mov    %eax,%esi
 cf2:	eb db                	jmp    ccf <printf+0x2c>
      if(c == 'd'){
 cf4:	83 f8 25             	cmp    $0x25,%eax
 cf7:	0f 84 cf 00 00 00    	je     dcc <printf+0x129>
 cfd:	0f 8c dd 00 00 00    	jl     de0 <printf+0x13d>
 d03:	83 f8 78             	cmp    $0x78,%eax
 d06:	0f 8f d4 00 00 00    	jg     de0 <printf+0x13d>
 d0c:	83 f8 63             	cmp    $0x63,%eax
 d0f:	0f 8c cb 00 00 00    	jl     de0 <printf+0x13d>
 d15:	83 e8 63             	sub    $0x63,%eax
 d18:	83 f8 15             	cmp    $0x15,%eax
 d1b:	0f 87 bf 00 00 00    	ja     de0 <printf+0x13d>
 d21:	ff 24 85 40 10 00 00 	jmp    *0x1040(,%eax,4)
        printint(fd, *ap, 10, 1);
 d28:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 d2b:	8b 17                	mov    (%edi),%edx
 d2d:	83 ec 0c             	sub    $0xc,%esp
 d30:	6a 01                	push   $0x1
 d32:	b9 0a 00 00 00       	mov    $0xa,%ecx
 d37:	8b 45 08             	mov    0x8(%ebp),%eax
 d3a:	e8 d9 fe ff ff       	call   c18 <printint>
        ap++;
 d3f:	83 c7 04             	add    $0x4,%edi
 d42:	89 7d e4             	mov    %edi,-0x1c(%ebp)
 ...
 d4d:	eb 80                	jmp    ccf <printf+0x2c>
        printint(fd, *ap, 16, 0);
 d4f:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 d52:	8b 17                	mov    (%edi),%edx
 d54:	83 ec 0c             	sub    $0xc,%esp
 d57:	6a 00                	push   $0x0
 d59:	b9 10 00 00 00       	mov    $0x10,%ecx
 d5e:	8b 45 08             	mov    0x8(%ebp),%eax
 d61:	e8 b2 fe ff ff       	call   c18 <printint>
        ap++;
 d66:	83 c7 04             	add    $0x4,%edi
 d69:	89 7d e4             	mov    %edi,-0x1c(%ebp)
 d6c:	83 c4 10             	add    $0x10,%esp
      state = 0;
 d6f:	be 00 00 00 00       	mov    $0x0,%esi
 d74:	e9 56 ff ff ff       	jmp    ccf <printf+0x2c>
        s = (char*)*ap;
 d79:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 d7c:	8b 30                	mov    (%eax),%esi
        ap++;
 d7e:	83 c0 04             	add    $0x4,%eax
 d81:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
 d84:	85 f6                	test   %esi,%esi
 d86:	75 15                	jne    d9d <printf+0xfa>
          s = "(null)";
 d88:	be 38 10 00 00       	mov    $0x1038,%esi
 d8d:	eb 0e                	jmp    d9d <printf+0xfa>
          putc(fd, *s);
 d8f:	0f be d2             	movsbl %dl,%edx
 d92:	8b 45 08             	mov    0x8(%ebp),%eax
 d95:	e8 64 fe ff ff       	call   bfe <putc>
          s++;
 d9a:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 d9d:	0f b6 16             	movzbl (%esi),%edx
 da0:	84 d2                	test   %dl,%dl
 da2:	75 eb                	jne    d8f <printf+0xec>
      state = 0;
 da4:	be 00 00 00 00       	mov    $0x0,%esi
 da9:	e9 21 ff ff ff       	jmp    ccf <printf+0x2c>
        putc(fd, *ap);
 dae:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 db1:	0f be 17             	movsbl (%edi),%edx
 db4:	8b 45 08             	mov    0x8(%ebp),%eax
 db7:	e8 42 fe ff ff       	call   bfe <putc>
        ap++;
 dbc:	83 c7 04             	add    $0x4,%edi
 dbf:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 dc2:	be 00 00 00 00       	mov    $0x0,%esi
 dc7:	e9 03 ff ff ff       	jmp    ccf <printf+0x2c>
        putc(fd, c);
 dcc:	89 fa                	mov    %edi,%edx
 dce:	8b 45 08             	mov    0x8(%ebp),%eax
 dd1:	e8 28 fe ff ff       	call   bfe <putc>
      state = 0;
 dd6:	be 00 00 00 00       	mov    $0x0,%esi
 ddb:	e9 ef fe ff ff       	jmp    ccf <printf+0x2c>
        putc(fd, '%');
 de0:	ba 25 00 00 00       	mov    $0x25,%edx
 de5:	8b 45 08             	mov    0x8(%ebp),%eax
 de8:	e8 11 fe ff ff       	call   bfe <putc>
        putc(fd, c);
 ded:	89 fa                	mov    %edi,%edx
 def:	8b 45 08             	mov    0x8(%ebp),%eax
 df2:	e8 07 fe ff ff       	call   bfe <putc>
      state = 0;
 df7:	be 00 00 00 00       	mov    $0x0,%esi
 dfc:	e9 ce fe ff ff       	jmp    ccf <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
 ...
 e15:	a1 84 16 00 00       	mov    0x1684,%eax
 ...
 e51:	89 08                	mov    %ecx,(%eax)
  freep = p;
 e53:	a3 84 16 00 00       	mov    %eax,0x1684
}
 e58:	5b                   	pop    %ebx
 e59:	5e                   	pop    %esi
 e5a:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 eb0:	e8 54 ff ff ff       	call   e09 <free>
  return freep;
 eb5:	a1 84 16 00 00       	mov    0x1684,%eax
...
malloc(uint nbytes)
{
 ...
 ed9:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 edc:	8b 0d 84 16 00 00    	mov    0x1684,%ecx
 ...
 ee8:	eb 4a                	jmp    f34 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 eea:	c7 05 84 16 00 00 88 	movl   $0x1688,0x1684
 ef1:	16 00 00 
 ef4:	c7 05 88 16 00 00 88 	movl   $0x1688,0x1688
 efb:	16 00 00 
    base.s.size = 0;
 efe:	c7 05 8c 16 00 00 00 	movl   $0x0,0x168c
 f05:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 f08:	b9 88 16 00 00       	mov    $0x1688,%ecx
 f0d:	eb d7                	jmp    ee6 <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 f0f:	74 19                	je     f2a <malloc+0x61>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 f11:	29 da                	sub    %ebx,%edx
 f13:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
 f16:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
 f19:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
 f1c:	89 0d 84 16 00 00    	mov    %ecx,0x1684
      return (void*)(p + 1);
 ...
 f2c:	89 11                	mov    %edx,(%ecx)
 f2e:	eb ec                	jmp    f1c <malloc+0x53>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 f30:	89 c1                	mov    %eax,%ecx
 f32:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
 f34:	8b 50 04             	mov    0x4(%eax),%edx
 f37:	39 da                	cmp    %ebx,%edx
 f39:	73 d4                	jae    f0f <malloc+0x46>
    if(p == freep)
 f3b:	39 05 84 16 00 00    	cmp    %eax,0x1684
 f41:	75 ed                	jne    f30 <malloc+0x67>
      if((p = morecore(nunits)) == 0)
 f43:	89 d8                	mov    %ebx,%eax
 f45:	e8 2f ff ff ff       	call   e79 <morecore>
 f4a:	85 c0                	test   %eax,%eax
 f4c:	75 e2                	jne    f30 <malloc+0x67>
 f4e:	eb d5                	jmp    f25 <malloc+0x5c>
