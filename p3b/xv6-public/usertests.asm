...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
      ...
      11:	e8 57 38 00 00       	call   386d <printf>
  ...
  printf(stdout, "iput test ok\n");
      ...
      73:	e8 f5 37 00 00       	call   386d <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
      ...
      8b:	e8 dd 37 00 00       	call   386d <printf>
    exit();
    ...
    printf(stdout, "chdir iputdir failed\n");
      ...
      a3:	e8 c5 37 00 00       	call   386d <printf>
    exit();
    ...
    printf(stdout, "unlink ../iputdir failed\n");
      ...
      bb:	e8 ad 37 00 00       	call   386d <printf>
    exit();
    ...
    printf(stdout, "chdir / failed\n");
      ...
      d3:	e8 95 37 00 00       	call   386d <printf>
    exit();
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      ee:	e8 7a 37 00 00       	call   386d <printf>
  ...
  if(pid == 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     154:	e8 14 37 00 00       	call   386d <printf>
    exit();
     ...
     16c:	e8 fc 36 00 00       	call   386d <printf>
      exit();
     ...
     184:	e8 e4 36 00 00       	call   386d <printf>
      exit();
     ...
     19c:	e8 cc 36 00 00       	call   386d <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1b9:	e8 af 36 00 00       	call   386d <printf>
}
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     1d4:	e8 94 36 00 00       	call   386d <printf>
  if(mkdir("oidir") < 0){
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     21b:	e8 4d 36 00 00       	call   386d <printf>
      exit();
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     233:	e8 35 36 00 00       	call   386d <printf>
    exit();
    ...
    printf(stdout, "fork failed\n");
     ...
     24b:	e8 1d 36 00 00       	call   386d <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     ...
     28a:	e8 de 35 00 00       	call   386d <printf>
}
    ...
    printf(stdout, "unlink failed\n");
     ...
     2a2:	e8 c6 35 00 00       	call   386d <printf>
    exit();
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     2bd:	e8 ab 35 00 00       	call   386d <printf>
  fd = open("echo", 0);
  ...
  printf(stdout, "open test ok\n");
     ...
     305:	e8 63 35 00 00       	call   386d <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     ...
     31d:	e8 4b 35 00 00       	call   386d <printf>
    exit();
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     335:	e8 33 35 00 00       	call   386d <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     352:	e8 16 35 00 00       	call   386d <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     380:	e8 e8 34 00 00       	call   386d <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3d5:	e8 93 34 00 00       	call   386d <printf>
    exit();
     ...
     3ee:	e8 7a 34 00 00       	call   386d <printf>
      exit();
     ...
     407:	e8 61 34 00 00       	call   386d <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     41f:	e8 49 34 00 00       	call   386d <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     452:	e8 16 34 00 00       	call   386d <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     482:	e8 e6 33 00 00       	call   386d <printf>
  } else {
  ...
  printf(stdout, "small file test ok\n");
     ...
     4b0:	e8 b8 33 00 00       	call   386d <printf>
}
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     4cd:	e8 9b 33 00 00       	call   386d <printf>
    exit();
    ...
    printf(stdout, "read failed\n");
     ...
     4e5:	e8 83 33 00 00       	call   386d <printf>
    exit();
    ...
    printf(stdout, "unlink small failed\n");
     ...
     4fd:	e8 6b 33 00 00       	call   386d <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     51a:	e8 4e 33 00 00       	call   386d <printf>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     57d:	e8 eb 32 00 00       	call   386d <printf>
    exit();
     ...
     596:	e8 d2 32 00 00       	call   386d <printf>
      exit();
  ...
  for(;;){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     60b:	e8 5d 32 00 00       	call   386d <printf>
    exit();
  ...
  printf(stdout, "big files ok\n");
     ...
     647:	e8 21 32 00 00       	call   386d <printf>
}
     ...
     665:	e8 03 32 00 00       	call   386d <printf>
        exit();
     ...
     67e:	e8 ea 31 00 00       	call   386d <printf>
      exit();
     ...
     695:	e8 d3 31 00 00       	call   386d <printf>
      exit();
    ...
    printf(stdout, "unlink big failed\n");
     ...
     6ad:	e8 bb 31 00 00       	call   386d <printf>
    exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     6c9:	e8 9f 31 00 00       	call   386d <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     756:	e8 12 31 00 00       	call   386d <printf>
}
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     774:	e8 f4 30 00 00       	call   386d <printf>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     7d6:	e8 92 30 00 00       	call   386d <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     7ee:	e8 7a 30 00 00       	call   386d <printf>
    exit();
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     806:	e8 62 30 00 00       	call   386d <printf>
    exit();
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     81e:	e8 4a 30 00 00       	call   386d <printf>
    exit();
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     836:	e8 32 30 00 00       	call   386d <printf>
    exit();
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     851:	e8 17 30 00 00       	call   386d <printf>
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     87f:	e8 e9 2f 00 00       	call   386d <printf>
    exit();
...
pipe1(void)
{
  ...
  seq = 0;
    ...
    printf(1, "pipe() failed\n");
     ...
     91e:	6a 01                	push   $0x1
     920:	e8 48 2f 00 00       	call   386d <printf>
    exit();
  ...
  seq = 0;
    ...
    for(n = 0; n < 5; n++){
     ...
     984:	6a 01                	push   $0x1
     986:	e8 e2 2e 00 00       	call   386d <printf>
        exit();
    ...
    exit();
     ...
     99d:	6a 01                	push   $0x1
     99f:	e8 c9 2e 00 00       	call   386d <printf>
          return;
  ...
  printf(1, "pipe1 ok\n");
     ...
     9f2:	6a 01                	push   $0x1
     9f4:	e8 74 2e 00 00       	call   386d <printf>
     ...
     a09:	6a 01                	push   $0x1
     a0b:	e8 5d 2e 00 00       	call   386d <printf>
      exit();
    ...
    printf(1, "fork() failed\n");
     ...
     a1d:	6a 01                	push   $0x1
     a1f:	e8 49 2e 00 00       	call   386d <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     a37:	6a 01                	push   $0x1
     a39:	e8 2f 2e 00 00       	call   386d <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    for(;;)
     ...
     ab2:	6a 01                	push   $0x1
     ab4:	e8 b4 2d 00 00       	call   386d <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     aee:	6a 01                	push   $0x1
     af0:	e8 78 2d 00 00       	call   386d <printf>
    return;
  ...
  printf(1, "kill... ");
     ...
     b13:	6a 01                	push   $0x1
     b15:	e8 53 2d 00 00       	call   386d <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     b3a:	6a 01                	push   $0x1
     b3c:	e8 2c 2d 00 00       	call   386d <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     b58:	6a 01                	push   $0x1
     b5a:	e8 0e 2d 00 00       	call   386d <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
     ...
     b96:	6a 01                	push   $0x1
     b98:	e8 d0 2c 00 00       	call   386d <printf>
      return;
  ...
  printf(1, "exitwait ok\n");
     ...
     baf:	6a 01                	push   $0x1
     bb1:	e8 b7 2c 00 00       	call   386d <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     bc8:	6a 01                	push   $0x1
     bca:	e8 9e 2c 00 00       	call   386d <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     be2:	6a 01                	push   $0x1
     be4:	e8 84 2c 00 00       	call   386d <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     c13:	e8 7b 2e 00 00       	call   3a93 <malloc>
    ...
    while(m1){
     ...
     c26:	53                   	push   %ebx
     c27:	e8 a7 2d 00 00       	call   39d3 <free>
    ...
    m1 = malloc(1024*20);
     ...
     c3d:	e8 51 2e 00 00       	call   3a93 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     c4c:	50                   	push   %eax
     c4d:	e8 81 2d 00 00       	call   39d3 <free>
    printf(1, "mem ok\n");
     c52:	83 c4 08             	add    $0x8,%esp
     c55:	68 40 3f 00 00       	push   $0x3f40
     c5a:	6a 01                	push   $0x1
     c5c:	e8 0c 2c 00 00       	call   386d <printf>
    exit();
     ...
     c6e:	6a 01                	push   $0x1
     c70:	e8 f8 2b 00 00       	call   386d <printf>
      kill(ppid);
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     ...
     c9d:	6a 01                	push   $0x1
     c9f:	e8 c9 2b 00 00       	call   386d <printf>
  ...
  for(i = 0; i < 1000; i++){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     d1e:	6a 01                	push   $0x1
     d20:	e8 48 2b 00 00       	call   386d <printf>
    return;
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     d3c:	6a 01                	push   $0x1
     d3e:	e8 2a 2b 00 00       	call   386d <printf>
      break;
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     da4:	6a 01                	push   $0x1
     da6:	e8 c2 2a 00 00       	call   386d <printf>
    return;
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     e07:	6a 01                	push   $0x1
     e09:	e8 5f 2a 00 00       	call   386d <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     e20:	6a 01                	push   $0x1
     e22:	e8 46 2a 00 00       	call   386d <printf>
    exit();
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
     ...
     e56:	6a 01                	push   $0x1
     e58:	e8 10 2a 00 00       	call   386d <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    if(pid < 0){
     ...
     e6f:	6a 01                	push   $0x1
     e71:	e8 f7 29 00 00       	call   386d <printf>
      exit();
    ...
    if(pid == 0){
     ...
     e83:	6a 01                	push   $0x1
     e85:	e8 e3 29 00 00       	call   386d <printf>
        exit();
     ...
     e98:	6a 01                	push   $0x1
     e9a:	e8 ce 29 00 00       	call   386d <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	6a 01                	push   $0x1
     f4e:	e8 1a 29 00 00       	call   386d <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fec:	6a 01                	push   $0x1
     fee:	e8 7a 28 00 00       	call   386d <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    ...
    1000:	6a 01                	push   $0x1
    1002:	e8 66 28 00 00       	call   386d <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    101f:	6a 01                	push   $0x1
    1021:	e8 47 28 00 00       	call   386d <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1051:	6a 01                	push   $0x1
    1053:	e8 15 28 00 00       	call   386d <printf>
      exit();
    ...
    1071:	6a 01                	push   $0x1
    1073:	e8 f5 27 00 00       	call   386d <printf>
          exit();
    ...
    10e2:	6a 01                	push   $0x1
    10e4:	e8 84 27 00 00       	call   386d <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    116d:	6a 01                	push   $0x1
    116f:	e8 f9 26 00 00       	call   386d <printf>
        exit();
    ...
    1189:	6a 01                	push   $0x1
    118b:	e8 dd 26 00 00       	call   386d <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    ...
    11f6:	6a 01                	push   $0x1
    11f8:	e8 70 26 00 00       	call   386d <printf>
}
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1214:	6a 01                	push   $0x1
    1216:	e8 52 26 00 00       	call   386d <printf>
  ...
  printf(1, "unlinkread ok\n");
    ...
    1317:	6a 01                	push   $0x1
    1319:	e8 4f 25 00 00       	call   386d <printf>
}
    ...
    1330:	6a 01                	push   $0x1
    1332:	e8 36 25 00 00       	call   386d <printf>
    exit();
    ...
    1344:	6a 01                	push   $0x1
    1346:	e8 22 25 00 00       	call   386d <printf>
    exit();
    ...
    1358:	6a 01                	push   $0x1
    135a:	e8 0e 25 00 00       	call   386d <printf>
    exit();
    ...
    136c:	6a 01                	push   $0x1
    136e:	e8 fa 24 00 00       	call   386d <printf>
    exit();
    ...
    1380:	6a 01                	push   $0x1
    1382:	e8 e6 24 00 00       	call   386d <printf>
    exit();
    ...
    1394:	6a 01                	push   $0x1
    1396:	e8 d2 24 00 00       	call   386d <printf>
    exit();
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    ...
    13ac:	6a 01                	push   $0x1
    13ae:	e8 ba 24 00 00       	call   386d <printf>
  ...
  printf(1, "linktest ok\n");
    ...
    1503:	6a 01                	push   $0x1
    1505:	e8 63 23 00 00       	call   386d <printf>
}
    ...
    151a:	6a 01                	push   $0x1
    151c:	e8 4c 23 00 00       	call   386d <printf>
    exit();
    ...
    152e:	6a 01                	push   $0x1
    1530:	e8 38 23 00 00       	call   386d <printf>
    exit();
    ...
    1542:	6a 01                	push   $0x1
    1544:	e8 24 23 00 00       	call   386d <printf>
    exit();
    ...
    1556:	6a 01                	push   $0x1
    1558:	e8 10 23 00 00       	call   386d <printf>
    exit();
    ...
    156a:	6a 01                	push   $0x1
    156c:	e8 fc 22 00 00       	call   386d <printf>
    exit();
    ...
    157e:	6a 01                	push   $0x1
    1580:	e8 e8 22 00 00       	call   386d <printf>
    exit();
    ...
    1592:	6a 01                	push   $0x1
    1594:	e8 d4 22 00 00       	call   386d <printf>
    exit();
    ...
    15a6:	6a 01                	push   $0x1
    15a8:	e8 c0 22 00 00       	call   386d <printf>
    exit();
    ...
    15ba:	6a 01                	push   $0x1
    15bc:	e8 ac 22 00 00       	call   386d <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    15d4:	6a 01                	push   $0x1
    15d6:	e8 92 22 00 00       	call   386d <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16d3:	6a 01                	push   $0x1
    16d5:	e8 93 21 00 00       	call   386d <printf>
        exit();
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    175f:	6a 01                	push   $0x1
    1761:	e8 07 21 00 00       	call   386d <printf>
        exit();
    ...
    1777:	6a 01                	push   $0x1
    1779:	e8 ef 20 00 00       	call   386d <printf>
        exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    17a6:	6a 01                	push   $0x1
    17a8:	e8 c0 20 00 00       	call   386d <printf>
    exit();
    ...
    17ba:	6a 01                	push   $0x1
    17bc:	e8 ac 20 00 00       	call   386d <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    ...
    18a2:	6a 01                	push   $0x1
    18a4:	e8 c4 1f 00 00       	call   386d <printf>
}
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    18c2:	6a 01                	push   $0x1
    18c4:	e8 a4 1f 00 00       	call   386d <printf>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    18f9:	6a 01                	push   $0x1
    18fb:	e8 6d 1f 00 00       	call   386d <printf>
    exit();
  ...
  printf(1, "linkunlink ok\n");
    ...
    1994:	6a 01                	push   $0x1
    1996:	e8 d2 1e 00 00       	call   386d <printf>
}
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    ...
    19b4:	6a 01                	push   $0x1
    19b6:	e8 b2 1e 00 00       	call   386d <printf>
  unlink("bd");
  ...
  for(i = 0; i < 500; i++){
    ...
    1a4d:	6a 01                	push   $0x1
    1a4f:	e8 19 1e 00 00       	call   386d <printf>
    exit();
    ...
    1a61:	6a 01                	push   $0x1
    1a63:	e8 05 1e 00 00       	call   386d <printf>
      exit();
  ...
  for(i = 0; i < 500; i++){
    ...
    1ad9:	6a 01                	push   $0x1
    1adb:	e8 8d 1d 00 00       	call   386d <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    ...
    1aed:	6a 01                	push   $0x1
    1aef:	e8 79 1d 00 00       	call   386d <printf>
}
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    ...
    1b08:	6a 01                	push   $0x1
    1b0a:	e8 5e 1d 00 00       	call   386d <printf>
  ...
  printf(1, "subdir ok\n");
    ...
    1f37:	6a 01                	push   $0x1
    1f39:	e8 2f 19 00 00       	call   386d <printf>
}
    ...
    1f4e:	6a 01                	push   $0x1
    1f50:	e8 18 19 00 00       	call   386d <printf>
    exit();
    ...
    1f62:	6a 01                	push   $0x1
    1f64:	e8 04 19 00 00       	call   386d <printf>
    exit();
    ...
    1f76:	6a 01                	push   $0x1
    1f78:	e8 f0 18 00 00       	call   386d <printf>
    exit();
    ...
    1f8a:	6a 01                	push   $0x1
    1f8c:	e8 dc 18 00 00       	call   386d <printf>
    exit();
    ...
    1f9e:	6a 01                	push   $0x1
    1fa0:	e8 c8 18 00 00       	call   386d <printf>
    exit();
    ...
    1fb2:	6a 01                	push   $0x1
    1fb4:	e8 b4 18 00 00       	call   386d <printf>
    exit();
    ...
    1fc6:	6a 01                	push   $0x1
    1fc8:	e8 a0 18 00 00       	call   386d <printf>
    exit();
    ...
    1fda:	6a 01                	push   $0x1
    1fdc:	e8 8c 18 00 00       	call   386d <printf>
    exit();
    ...
    1fee:	6a 01                	push   $0x1
    1ff0:	e8 78 18 00 00       	call   386d <printf>
    exit();
    ...
    2002:	6a 01                	push   $0x1
    2004:	e8 64 18 00 00       	call   386d <printf>
    exit();
    ...
    2016:	6a 01                	push   $0x1
    2018:	e8 50 18 00 00       	call   386d <printf>
    exit();
    ...
    202a:	6a 01                	push   $0x1
    202c:	e8 3c 18 00 00       	call   386d <printf>
    exit();
    ...
    203e:	6a 01                	push   $0x1
    2040:	e8 28 18 00 00       	call   386d <printf>
    exit();
    ...
    2052:	6a 01                	push   $0x1
    2054:	e8 14 18 00 00       	call   386d <printf>
    exit();
    ...
    2066:	6a 01                	push   $0x1
    2068:	e8 00 18 00 00       	call   386d <printf>
    exit();
    ...
    207a:	6a 01                	push   $0x1
    207c:	e8 ec 17 00 00       	call   386d <printf>
    exit();
    ...
    208e:	6a 01                	push   $0x1
    2090:	e8 d8 17 00 00       	call   386d <printf>
    exit();
    ...
    20a2:	6a 01                	push   $0x1
    20a4:	e8 c4 17 00 00       	call   386d <printf>
    exit();
    ...
    20b6:	6a 01                	push   $0x1
    20b8:	e8 b0 17 00 00       	call   386d <printf>
    exit();
    ...
    20ca:	6a 01                	push   $0x1
    20cc:	e8 9c 17 00 00       	call   386d <printf>
    exit();
    ...
    20de:	6a 01                	push   $0x1
    20e0:	e8 88 17 00 00       	call   386d <printf>
    exit();
    ...
    20f2:	6a 01                	push   $0x1
    20f4:	e8 74 17 00 00       	call   386d <printf>
    exit();
    ...
    2106:	6a 01                	push   $0x1
    2108:	e8 60 17 00 00       	call   386d <printf>
    exit();
    ...
    211a:	6a 01                	push   $0x1
    211c:	e8 4c 17 00 00       	call   386d <printf>
    exit();
    ...
    212e:	6a 01                	push   $0x1
    2130:	e8 38 17 00 00       	call   386d <printf>
    exit();
    ...
    2142:	6a 01                	push   $0x1
    2144:	e8 24 17 00 00       	call   386d <printf>
    exit();
    ...
    2156:	6a 01                	push   $0x1
    2158:	e8 10 17 00 00       	call   386d <printf>
    exit();
    ...
    216a:	6a 01                	push   $0x1
    216c:	e8 fc 16 00 00       	call   386d <printf>
    exit();
    ...
    217e:	6a 01                	push   $0x1
    2180:	e8 e8 16 00 00       	call   386d <printf>
    exit();
    ...
    2192:	6a 01                	push   $0x1
    2194:	e8 d4 16 00 00       	call   386d <printf>
    exit();
    ...
    21a6:	6a 01                	push   $0x1
    21a8:	e8 c0 16 00 00       	call   386d <printf>
    exit();
    ...
    21ba:	6a 01                	push   $0x1
    21bc:	e8 ac 16 00 00       	call   386d <printf>
    exit();
    ...
    21ce:	6a 01                	push   $0x1
    21d0:	e8 98 16 00 00       	call   386d <printf>
    exit();
    ...
    21e2:	6a 01                	push   $0x1
    21e4:	e8 84 16 00 00       	call   386d <printf>
    exit();
    ...
    21f6:	6a 01                	push   $0x1
    21f8:	e8 70 16 00 00       	call   386d <printf>
    exit();
    ...
    220a:	6a 01                	push   $0x1
    220c:	e8 5c 16 00 00       	call   386d <printf>
    exit();
    ...
    221e:	6a 01                	push   $0x1
    2220:	e8 48 16 00 00       	call   386d <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    2238:	6a 01                	push   $0x1
    223a:	e8 2e 16 00 00       	call   386d <printf>
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    225d:	6a 01                	push   $0x1
    225f:	e8 09 16 00 00       	call   386d <printf>
      exit();
    ...
    2270:	6a 01                	push   $0x1
    2272:	e8 f6 15 00 00       	call   386d <printf>
        exit();
  ...
  printf(1, "bigwrite ok\n");
    ...
    22ea:	6a 01                	push   $0x1
    22ec:	e8 7c 15 00 00       	call   386d <printf>
}
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    ...
    230a:	6a 01                	push   $0x1
    230c:	e8 5c 15 00 00       	call   386d <printf>
  ...
  for(i = 0; i < 20; i++){
    ...
    237f:	6a 01                	push   $0x1
    2381:	e8 e7 14 00 00       	call   386d <printf>
    exit();
    ...
    2393:	6a 01                	push   $0x1
    2395:	e8 d3 14 00 00       	call   386d <printf>
      exit();
  ...
  for(i = 0; ; i++){
    ...
    241b:	6a 01                	push   $0x1
    241d:	e8 4b 14 00 00       	call   386d <printf>
    exit();
    ...
    242f:	6a 01                	push   $0x1
    2431:	e8 37 14 00 00       	call   386d <printf>
      exit();
    ...
    2443:	6a 01                	push   $0x1
    2445:	e8 23 14 00 00       	call   386d <printf>
      exit();
    ...
    2457:	6a 01                	push   $0x1
    2459:	e8 0f 14 00 00       	call   386d <printf>
      exit();
  ...
  printf(1, "bigfile test ok\n");
    ...
    248c:	6a 01                	push   $0x1
    248e:	e8 da 13 00 00       	call   386d <printf>
}
    ...
    24a6:	6a 01                	push   $0x1
    24a8:	e8 c0 13 00 00       	call   386d <printf>
    exit();
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    24bd:	6a 01                	push   $0x1
    24bf:	e8 a9 13 00 00       	call   386d <printf>
  ...
  printf(1, "fourteen ok\n");
    ...
    256b:	6a 01                	push   $0x1
    256d:	e8 fb 12 00 00       	call   386d <printf>
}
    ...
    257f:	6a 01                	push   $0x1
    2581:	e8 e7 12 00 00       	call   386d <printf>
    exit();
    ...
    2593:	6a 01                	push   $0x1
    2595:	e8 d3 12 00 00       	call   386d <printf>
    exit();
    ...
    25a7:	6a 01                	push   $0x1
    25a9:	e8 bf 12 00 00       	call   386d <printf>
    exit();
    ...
    25bb:	6a 01                	push   $0x1
    25bd:	e8 ab 12 00 00       	call   386d <printf>
    exit();
    ...
    25cf:	6a 01                	push   $0x1
    25d1:	e8 97 12 00 00       	call   386d <printf>
    exit();
    ...
    25e3:	6a 01                	push   $0x1
    25e5:	e8 83 12 00 00       	call   386d <printf>
    exit();
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    25fa:	6a 01                	push   $0x1
    25fc:	e8 6c 12 00 00       	call   386d <printf>
  if(mkdir("dots") != 0){
  ...
  printf(1, "rmdot ok\n");
    ...
    26c8:	6a 01                	push   $0x1
    26ca:	e8 9e 11 00 00       	call   386d <printf>
}
    ...
    26dc:	6a 01                	push   $0x1
    26de:	e8 8a 11 00 00       	call   386d <printf>
    exit();
    ...
    26f0:	6a 01                	push   $0x1
    26f2:	e8 76 11 00 00       	call   386d <printf>
    exit();
    ...
    2704:	6a 01                	push   $0x1
    2706:	e8 62 11 00 00       	call   386d <printf>
    exit();
    ...
    2718:	6a 01                	push   $0x1
    271a:	e8 4e 11 00 00       	call   386d <printf>
    exit();
    ...
    272c:	6a 01                	push   $0x1
    272e:	e8 3a 11 00 00       	call   386d <printf>
    exit();
    ...
    2740:	6a 01                	push   $0x1
    2742:	e8 26 11 00 00       	call   386d <printf>
    exit();
    ...
    2754:	6a 01                	push   $0x1
    2756:	e8 12 11 00 00       	call   386d <printf>
    exit();
    ...
    2768:	6a 01                	push   $0x1
    276a:	e8 fe 10 00 00       	call   386d <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    ...
    2780:	6a 01                	push   $0x1
    2782:	e8 e6 10 00 00       	call   386d <printf>
  ...
  printf(1, "dir vs file OK\n");
    ...
    28b7:	6a 01                	push   $0x1
    28b9:	e8 af 0f 00 00       	call   386d <printf>
}
    ...
    28ce:	6a 01                	push   $0x1
    28d0:	e8 98 0f 00 00       	call   386d <printf>
    exit();
    ...
    28e2:	6a 01                	push   $0x1
    28e4:	e8 84 0f 00 00       	call   386d <printf>
    exit();
    ...
    28f6:	6a 01                	push   $0x1
    28f8:	e8 70 0f 00 00       	call   386d <printf>
    exit();
    ...
    290a:	6a 01                	push   $0x1
    290c:	e8 5c 0f 00 00       	call   386d <printf>
    exit();
    ...
    291e:	6a 01                	push   $0x1
    2920:	e8 48 0f 00 00       	call   386d <printf>
    exit();
    ...
    2932:	6a 01                	push   $0x1
    2934:	e8 34 0f 00 00       	call   386d <printf>
    exit();
    ...
    2946:	6a 01                	push   $0x1
    2948:	e8 20 0f 00 00       	call   386d <printf>
    exit();
    ...
    295a:	6a 01                	push   $0x1
    295c:	e8 0c 0f 00 00       	call   386d <printf>
    exit();
    ...
    296e:	6a 01                	push   $0x1
    2970:	e8 f8 0e 00 00       	call   386d <printf>
    exit();
    ...
    2982:	6a 01                	push   $0x1
    2984:	e8 e4 0e 00 00       	call   386d <printf>
    exit();
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    299a:	6a 01                	push   $0x1
    299c:	e8 cc 0e 00 00       	call   386d <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    29b3:	6a 01                	push   $0x1
    29b5:	e8 b3 0e 00 00       	call   386d <printf>
      exit();
    ...
    29c7:	6a 01                	push   $0x1
    29c9:	e8 9f 0e 00 00       	call   386d <printf>
      exit();
  ...
  printf(1, "empty file name OK\n");
    ...
    2aa7:	6a 01                	push   $0x1
    2aa9:	e8 bf 0d 00 00       	call   386d <printf>
}
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    2ac2:	6a 01                	push   $0x1
    2ac4:	e8 a4 0d 00 00       	call   386d <printf>
  ...
  for(; n > 0; n--){
    ...
    2b10:	6a 01                	push   $0x1
    2b12:	e8 56 0d 00 00       	call   386d <printf>
    exit();
    ...
    2b24:	6a 01                	push   $0x1
    2b26:	e8 42 0d 00 00       	call   386d <printf>
      exit();
  ...
  printf(1, "fork test OK\n");
    ...
    2b42:	6a 01                	push   $0x1
    2b44:	e8 24 0d 00 00       	call   386d <printf>
}
    ...
    2b59:	6a 01                	push   $0x1
    2b5b:	e8 0d 0d 00 00       	call   386d <printf>
    exit();
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2b79:	e8 ef 0c 00 00       	call   386d <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    2bd7:	e8 91 0c 00 00       	call   386d <printf>
      exit();
...
#define BIG (100*1024*1024)
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2d42:	68 32 49 00 00       	push   $0x4932
    2d47:	ff 35 a4 5b 00 00    	push   0x5ba4
    2d4d:	e8 1b 0b 00 00       	call   386d <printf>
    exit();
    2d52:	e8 c1 09 00 00       	call   3718 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    2d57:	83 ec 08             	sub    $0x8,%esp
    2d5a:	68 49 49 00 00       	push   $0x4949
    2d5f:	ff 35 a4 5b 00 00    	push   0x5ba4
    2d65:	e8 03 0b 00 00       	call   386d <printf>
    exit();
    ...
    2d77:	68 90 50 00 00       	push   $0x5090
    2d7c:	ff 35 a4 5b 00 00    	push   0x5ba4
    2d82:	e8 e6 0a 00 00       	call   386d <printf>
    exit();
    2d87:	e8 8c 09 00 00       	call   3718 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    2d8c:	83 ec 08             	sub    $0x8,%esp
    2d8f:	68 65 49 00 00       	push   $0x4965
    2d94:	ff 35 a4 5b 00 00    	push   0x5ba4
    2d9a:	e8 ce 0a 00 00       	call   386d <printf>
    exit();
    2d9f:	e8 74 09 00 00       	call   3718 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    2da4:	50                   	push   %eax
    2da5:	53                   	push   %ebx
    2da6:	68 d0 50 00 00       	push   $0x50d0
    2dab:	ff 35 a4 5b 00 00    	push   0x5ba4
    2db1:	e8 b7 0a 00 00       	call   386d <printf>
    exit();
    2db6:	e8 5d 09 00 00       	call   3718 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    2dbb:	56                   	push   %esi
    2dbc:	53                   	push   %ebx
    2dbd:	68 08 51 00 00       	push   $0x5108
    2dc2:	ff 35 a4 5b 00 00    	push   0x5ba4
    2dc8:	e8 a0 0a 00 00       	call   386d <printf>
    exit();
    2dcd:	e8 46 09 00 00       	call   3718 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    2dd2:	83 ec 08             	sub    $0x8,%esp
    2dd5:	68 30 51 00 00       	push   $0x5130
    2dda:	ff 35 a4 5b 00 00    	push   0x5ba4
    2de0:	e8 88 0a 00 00       	call   386d <printf>
    exit();
    2de5:	e8 2e 09 00 00       	call   3718 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    2dea:	50                   	push   %eax
    2deb:	53                   	push   %ebx
    2dec:	68 60 51 00 00       	push   $0x5160
    2df1:	ff 35 a4 5b 00 00    	push   0x5ba4
    2df7:	e8 71 0a 00 00       	call   386d <printf>
    exit();
    2dfc:	e8 17 09 00 00       	call   3718 <exit>
      printf(stdout, "fork failed\n");
    2e01:	83 ec 08             	sub    $0x8,%esp
    2e04:	68 5d 4a 00 00       	push   $0x4a5d
    2e09:	ff 35 a4 5b 00 00    	push   0x5ba4
    2e0f:	e8 59 0a 00 00       	call   386d <printf>
      exit();
    ...
    2e1c:	50                   	push   %eax
    2e1d:	53                   	push   %ebx
    2e1e:	68 80 49 00 00       	push   $0x4980
    2e23:	ff 35 a4 5b 00 00    	push   0x5ba4
    2e29:	e8 3f 0a 00 00       	call   386d <printf>
      kill(ppid);
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2e57:	68 55 3e 00 00       	push   $0x3e55
    2e5c:	6a 01                	push   $0x1
    2e5e:	e8 0a 0a 00 00       	call   386d <printf>
    exit();
    ...
    2e86:	6a 01                	push   $0x1
    2e88:	68 75 44 00 00       	push   $0x4475
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f2b:	68 b4 49 00 00       	push   $0x49b4
    2f30:	ff 35 a4 5b 00 00    	push   0x5ba4
    2f36:	e8 32 09 00 00       	call   386d <printf>
}
    ...
    2f49:	68 99 49 00 00       	push   $0x4999
    2f4e:	ff 35 a4 5b 00 00    	push   0x5ba4
    2f54:	e8 14 09 00 00       	call   386d <printf>
    exit();
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    2f80:	68 c2 49 00 00       	push   $0x49c2
    2f85:	ff 35 a4 5b 00 00    	push   0x5ba4
    2f8b:	e8 dd 08 00 00       	call   386d <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2fd1:	56                   	push   %esi
    2fd2:	68 d1 49 00 00       	push   $0x49d1
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2ff4:	68 dc 49 00 00       	push   $0x49dc
    2ff9:	ff 35 a4 5b 00 00    	push   0x5ba4
    2fff:	e8 69 08 00 00       	call   386d <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    ...
    300c:	68 f5 49 00 00       	push   $0x49f5
    3011:	ff 35 a4 5b 00 00    	push   0x5ba4
    3017:	e8 51 08 00 00       	call   386d <printf>
}
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    302c:	68 02 4a 00 00       	push   $0x4a02
    3031:	ff 35 a4 5b 00 00    	push   0x5ba4
    3037:	e8 31 08 00 00       	call   386d <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    304b:	80 b8 c0 5b 00 00 00 	cmpb   $0x0,0x5bc0(%eax)
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    305c:	68 0c 4a 00 00       	push   $0x4a0c
    3061:	ff 35 a4 5b 00 00    	push   0x5ba4
    3067:	e8 01 08 00 00       	call   386d <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    ...
    3074:	68 1d 4a 00 00       	push   $0x4a1d
    3079:	ff 35 a4 5b 00 00    	push   0x5ba4
    307f:	e8 e9 07 00 00       	call   386d <printf>
}
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    308f:	68 2a 4a 00 00       	push   $0x4a2a
  ...
  fd = open("bigarg-ok", 0);
    ...
    30b3:	6a 00                	push   $0x0
    30b5:	68 2a 4a 00 00       	push   $0x4a2a
  ...
  unlink("bigarg-ok");
    30d3:	c7 04 24 2a 4a 00 00 	movl   $0x4a2a,(%esp)
    ...
    30e4:	c7 04 85 e0 a2 00 00 	movl   $0x5184,0xa2e0(,%eax,4)
    30eb:	84 51 00 00 
    ...
    args[MAXARG-1] = 0;
    30f7:	c7 05 5c a3 00 00 00 	movl   $0x0,0xa35c
    30fe:	00 00 00 
    printf(stdout, "bigarg test\n");
    3101:	83 ec 08             	sub    $0x8,%esp
    3104:	68 34 4a 00 00       	push   $0x4a34
    3109:	ff 35 a4 5b 00 00    	push   0x5ba4
    310f:	e8 59 07 00 00       	call   386d <printf>
    exec("echo", args);
    3114:	83 c4 08             	add    $0x8,%esp
    3117:	68 e0 a2 00 00       	push   $0xa2e0
    311c:	68 01 3c 00 00       	push   $0x3c01
    3121:	e8 2a 06 00 00       	call   3750 <exec>
    printf(stdout, "bigarg test ok\n");
    3126:	83 c4 08             	add    $0x8,%esp
    3129:	68 41 4a 00 00       	push   $0x4a41
    312e:	ff 35 a4 5b 00 00    	push   0x5ba4
    3134:	e8 34 07 00 00       	call   386d <printf>
    fd = open("bigarg-ok", O_CREATE);
    3139:	83 c4 08             	add    $0x8,%esp
    313c:	68 00 02 00 00       	push   $0x200
    3141:	68 2a 4a 00 00       	push   $0x4a2a
    ...
    315b:	68 51 4a 00 00       	push   $0x4a51
    3160:	ff 35 a4 5b 00 00    	push   0x5ba4
    3166:	e8 02 07 00 00       	call   386d <printf>
    exit();
    316b:	e8 a8 05 00 00       	call   3718 <exit>
    printf(stdout, "bigarg test failed!\n");
    3170:	83 ec 08             	sub    $0x8,%esp
    3173:	68 6a 4a 00 00       	push   $0x4a6a
    3178:	ff 35 a4 5b 00 00    	push   0x5ba4
    317e:	e8 ea 06 00 00       	call   386d <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    3191:	68 7f 4a 00 00       	push   $0x4a7f
    3196:	6a 01                	push   $0x1
    3198:	e8 d0 06 00 00       	call   386d <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    322e:	56                   	push   %esi
    322f:	68 8c 4a 00 00       	push   $0x4a8c
    3234:	6a 01                	push   $0x1
    3236:	e8 32 06 00 00       	call   386d <printf>
    ...
    3258:	50                   	push   %eax
    3259:	68 98 4a 00 00       	push   $0x4a98
    325e:	6a 01                	push   $0x1
    3260:	e8 08 06 00 00       	call   386d <printf>
      break;
    ...
    327a:	68 e0 82 00 00       	push   $0x82e0
    327f:	56                   	push   %esi
    ...
    3296:	57                   	push   %edi
    3297:	68 a8 4a 00 00       	push   $0x4aa8
    329c:	6a 01                	push   $0x1
    329e:	e8 ca 05 00 00       	call   386d <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    ...
    335e:	68 b8 4a 00 00       	push   $0x4ab8
    3363:	6a 01                	push   $0x1
    3365:	e8 03 05 00 00       	call   386d <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    337b:	68 ce 4a 00 00       	push   $0x4ace
    3380:	6a 01                	push   $0x1
    3382:	e8 e6 04 00 00       	call   386d <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    339d:	68 d8 4a 00 00       	push   $0x4ad8
    33a2:	6a 01                	push   $0x1
    33a4:	e8 c4 04 00 00       	call   386d <printf>
}
    ...
    33c2:	68 64 52 00 00       	push   $0x5264
    33c7:	6a 01                	push   $0x1
    33c9:	e8 9f 04 00 00       	call   386d <printf>
    exit();
    33ce:	e8 45 03 00 00       	call   3718 <exit>
    printf (1, "fork failed\n");
    33d3:	83 ec 08             	sub    $0x8,%esp
    33d6:	68 5d 4a 00 00       	push   $0x4a5d
    33db:	6a 01                	push   $0x1
    33dd:	e8 8b 04 00 00       	call   386d <printf>
    exit();
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    33ee:	6a 00                	push   $0x0
    33f0:	68 e7 4a 00 00       	push   $0x4ae7
  ...
  printf(1, "arg test passed\n");
    ...
    3427:	68 f9 4a 00 00       	push   $0x4af9
    342c:	6a 01                	push   $0x1
    342e:	e8 3a 04 00 00       	call   386d <printf>
}
    ...
    343e:	68 ec 4a 00 00       	push   $0x4aec
    3443:	6a 02                	push   $0x2
    3445:	e8 23 04 00 00       	call   386d <printf>
    exit();
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    344f:	69 05 a0 5b 00 00 0d 	imul   $0x19660d,0x5ba0,%eax
    3456:	66 19 00 
    3459:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    345e:	a3 a0 5b 00 00       	mov    %eax,0x5ba0
  return randstate;
}
    3463:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    3475:	68 0a 4b 00 00       	push   $0x4b0a
    347a:	6a 01                	push   $0x1
    347c:	e8 ec 03 00 00       	call   386d <printf>

  if(open("usertests.ran", 0) >= 0){
    3481:	83 c4 08             	add    $0x8,%esp
    3484:	6a 00                	push   $0x0
    3486:	68 1e 4b 00 00       	push   $0x4b1e
    ...
    349a:	68 88 52 00 00       	push   $0x5288
    349f:	6a 01                	push   $0x1
    34a1:	e8 c7 03 00 00       	call   386d <printf>
    exit();
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    34b3:	68 1e 4b 00 00       	push   $0x4b1e
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    37d6:	52                   	push   %edx
    37d7:	50                   	push   %eax
    37d8:	e8 5b ff ff ff       	call   3738 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    37eb:	89 45 d0             	mov    %eax,-0x30(%ebp)
    37ee:	89 d0                	mov    %edx,%eax
    37f0:	89 ce                	mov    %ecx,%esi
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    37f2:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    37f6:	0f 95 c1             	setne  %cl
    37f9:	c1 ea 1f             	shr    $0x1f,%edx
    37fc:	84 d1                	test   %dl,%cl
    37fe:	74 44                	je     3844 <printint+0x62>
    neg = 1;
    x = -xx;
    3800:	f7 d8                	neg    %eax
    3802:	89 c1                	mov    %eax,%ecx
    neg = 1;
    3804:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    380b:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
    3810:	89 c8                	mov    %ecx,%eax
    3812:	ba 00 00 00 00       	mov    $0x0,%edx
    3817:	f7 f6                	div    %esi
    3819:	89 df                	mov    %ebx,%edi
    381b:	83 c3 01             	add    $0x1,%ebx
    381e:	0f b6 92 14 53 00 00 	movzbl 0x5314(%edx),%edx
    3825:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
    3829:	89 ca                	mov    %ecx,%edx
    382b:	89 c1                	mov    %eax,%ecx
    382d:	39 d6                	cmp    %edx,%esi
    382f:	76 df                	jbe    3810 <printint+0x2e>
  if(neg)
    3831:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
    3835:	74 31                	je     3868 <printint+0x86>
    buf[i++] = '-';
    3837:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    383c:	8d 5f 02             	lea    0x2(%edi),%ebx
    383f:	8b 75 d0             	mov    -0x30(%ebp),%esi
    3842:	eb 17                	jmp    385b <printint+0x79>
    x = xx;
    3844:	89 c1                	mov    %eax,%ecx
  neg = 0;
    3846:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
    384d:	eb bc                	jmp    380b <printint+0x29>

  while(--i >= 0)
    putc(fd, buf[i]);
    384f:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
    3854:	89 f0                	mov    %esi,%eax
    3856:	e8 6d ff ff ff       	call   37c8 <putc>
  while(--i >= 0)
    385b:	83 eb 01             	sub    $0x1,%ebx
    385e:	79 ef                	jns    384f <printint+0x6d>
}
    3860:	83 c4 2c             	add    $0x2c,%esp
    3863:	5b                   	pop    %ebx
    3864:	5e                   	pop    %esi
    3865:	5f                   	pop    %edi
    3866:	5d                   	pop    %ebp
    3867:	c3                   	ret    
    3868:	8b 75 d0             	mov    -0x30(%ebp),%esi
    386b:	eb ee                	jmp    385b <printint+0x79>
...
printf(int fd, const char *fmt, ...)
{
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    3876:	8d 45 10             	lea    0x10(%ebp),%eax
    3879:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
    387c:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
    3881:	bb 00 00 00 00       	mov    $0x0,%ebx
    3886:	eb 14                	jmp    389c <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
    3888:	89 fa                	mov    %edi,%edx
    388a:	8b 45 08             	mov    0x8(%ebp),%eax
    388d:	e8 36 ff ff ff       	call   37c8 <putc>
    3892:	eb 05                	jmp    3899 <printf+0x2c>
      }
    } else if(state == '%'){
    3894:	83 fe 25             	cmp    $0x25,%esi
    3897:	74 25                	je     38be <printf+0x51>
  for(i = 0; fmt[i]; i++){
    3899:	83 c3 01             	add    $0x1,%ebx
    389c:	8b 45 0c             	mov    0xc(%ebp),%eax
    389f:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
    38a3:	84 c0                	test   %al,%al
    38a5:	0f 84 20 01 00 00    	je     39cb <printf+0x15e>
    c = fmt[i] & 0xff;
    38ab:	0f be f8             	movsbl %al,%edi
    38ae:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
    38b1:	85 f6                	test   %esi,%esi
    38b3:	75 df                	jne    3894 <printf+0x27>
      if(c == '%'){
    38b5:	83 f8 25             	cmp    $0x25,%eax
    38b8:	75 ce                	jne    3888 <printf+0x1b>
        state = '%';
    38ba:	89 c6                	mov    %eax,%esi
    38bc:	eb db                	jmp    3899 <printf+0x2c>
      if(c == 'd'){
    38be:	83 f8 25             	cmp    $0x25,%eax
    38c1:	0f 84 cf 00 00 00    	je     3996 <printf+0x129>
    38c7:	0f 8c dd 00 00 00    	jl     39aa <printf+0x13d>
    38cd:	83 f8 78             	cmp    $0x78,%eax
    38d0:	0f 8f d4 00 00 00    	jg     39aa <printf+0x13d>
    38d6:	83 f8 63             	cmp    $0x63,%eax
    38d9:	0f 8c cb 00 00 00    	jl     39aa <printf+0x13d>
    38df:	83 e8 63             	sub    $0x63,%eax
    38e2:	83 f8 15             	cmp    $0x15,%eax
    38e5:	0f 87 bf 00 00 00    	ja     39aa <printf+0x13d>
    38eb:	ff 24 85 bc 52 00 00 	jmp    *0x52bc(,%eax,4)
        printint(fd, *ap, 10, 1);
    38f2:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    38f5:	8b 17                	mov    (%edi),%edx
    38f7:	83 ec 0c             	sub    $0xc,%esp
    38fa:	6a 01                	push   $0x1
    38fc:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3901:	8b 45 08             	mov    0x8(%ebp),%eax
    3904:	e8 d9 fe ff ff       	call   37e2 <printint>
        ap++;
    3909:	83 c7 04             	add    $0x4,%edi
    390c:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    ...
    393e:	e9 56 ff ff ff       	jmp    3899 <printf+0x2c>
        s = (char*)*ap;
    3943:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3946:	8b 30                	mov    (%eax),%esi
        ap++;
    3948:	83 c0 04             	add    $0x4,%eax
    394b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
    394e:	85 f6                	test   %esi,%esi
    3950:	75 15                	jne    3967 <printf+0xfa>
          s = "(null)";
    3952:	be b2 52 00 00       	mov    $0x52b2,%esi
    3957:	eb 0e                	jmp    3967 <printf+0xfa>
          putc(fd, *s);
    3959:	0f be d2             	movsbl %dl,%edx
    395c:	8b 45 08             	mov    0x8(%ebp),%eax
    395f:	e8 64 fe ff ff       	call   37c8 <putc>
          s++;
    3964:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
    3967:	0f b6 16             	movzbl (%esi),%edx
    396a:	84 d2                	test   %dl,%dl
    396c:	75 eb                	jne    3959 <printf+0xec>
      state = 0;
    396e:	be 00 00 00 00       	mov    $0x0,%esi
    3973:	e9 21 ff ff ff       	jmp    3899 <printf+0x2c>
        putc(fd, *ap);
    3978:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    397b:	0f be 17             	movsbl (%edi),%edx
    397e:	8b 45 08             	mov    0x8(%ebp),%eax
    3981:	e8 42 fe ff ff       	call   37c8 <putc>
        ap++;
    3986:	83 c7 04             	add    $0x4,%edi
    3989:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
    398c:	be 00 00 00 00       	mov    $0x0,%esi
    3991:	e9 03 ff ff ff       	jmp    3899 <printf+0x2c>
        putc(fd, c);
    3996:	89 fa                	mov    %edi,%edx
    3998:	8b 45 08             	mov    0x8(%ebp),%eax
    399b:	e8 28 fe ff ff       	call   37c8 <putc>
      state = 0;
    39a0:	be 00 00 00 00       	mov    $0x0,%esi
    39a5:	e9 ef fe ff ff       	jmp    3899 <printf+0x2c>
        putc(fd, '%');
    39aa:	ba 25 00 00 00       	mov    $0x25,%edx
    39af:	8b 45 08             	mov    0x8(%ebp),%eax
    39b2:	e8 11 fe ff ff       	call   37c8 <putc>
        putc(fd, c);
    39b7:	89 fa                	mov    %edi,%edx
    39b9:	8b 45 08             	mov    0x8(%ebp),%eax
    39bc:	e8 07 fe ff ff       	call   37c8 <putc>
      state = 0;
    39c1:	be 00 00 00 00       	mov    $0x0,%esi
    39c6:	e9 ce fe ff ff       	jmp    3899 <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    39df:	a1 60 a3 00 00       	mov    0xa360,%eax
  ...
  freep = p;
    3a1d:	a3 60 a3 00 00       	mov    %eax,0xa360
}
    3a22:	5b                   	pop    %ebx
    3a23:	5e                   	pop    %esi
    3a24:	5f                   	pop    %edi
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3a62:	50                   	push   %eax
    3a63:	e8 38 fd ff ff       	call   37a0 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3a7f:	a1 60 a3 00 00       	mov    0xa360,%eax
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3aa6:	8b 0d 60 a3 00 00    	mov    0xa360,%ecx
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3ab2:	eb 4a                	jmp    3afe <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
    3ab4:	c7 05 60 a3 00 00 64 	movl   $0xa364,0xa360
    3abb:	a3 00 00 
    3abe:	c7 05 64 a3 00 00 64 	movl   $0xa364,0xa364
    3ac5:	a3 00 00 
    base.s.size = 0;
    3ac8:	c7 05 68 a3 00 00 00 	movl   $0x0,0xa368
    3acf:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    3ad2:	b9 64 a3 00 00       	mov    $0xa364,%ecx
    3ad7:	eb d7                	jmp    3ab0 <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    3ad9:	74 19                	je     3af4 <malloc+0x61>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    3adb:	29 da                	sub    %ebx,%edx
    3add:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    3ae0:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    3ae3:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    3ae6:	89 0d 60 a3 00 00    	mov    %ecx,0xa360
      return (void*)(p + 1);
    3aec:	83 c0 08             	add    $0x8,%eax
    }
    if(p == freep)
    ...
    3aef:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3af2:	c9                   	leave  
    3af3:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    3af4:	8b 10                	mov    (%eax),%edx
    3af6:	89 11                	mov    %edx,(%ecx)
    3af8:	eb ec                	jmp    3ae6 <malloc+0x53>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3afa:	89 c1                	mov    %eax,%ecx
    3afc:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
    3afe:	8b 50 04             	mov    0x4(%eax),%edx
    3b01:	39 da                	cmp    %ebx,%edx
    3b03:	73 d4                	jae    3ad9 <malloc+0x46>
    if(p == freep)
    3b05:	39 05 60 a3 00 00    	cmp    %eax,0xa360
    3b0b:	75 ed                	jne    3afa <malloc+0x67>
      if((p = morecore(nunits)) == 0)
    3b0d:	89 d8                	mov    %ebx,%eax
    3b0f:	e8 2f ff ff ff       	call   3a43 <morecore>
    3b14:	85 c0                	test   %eax,%eax
    3b16:	75 e2                	jne    3afa <malloc+0x67>
    3b18:	eb d5                	jmp    3aef <malloc+0x5c>
